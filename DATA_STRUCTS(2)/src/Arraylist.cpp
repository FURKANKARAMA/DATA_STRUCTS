...
void Arraylist::add(int item) { //dizinin sonuna ekleme yapar

    insert(length, item);
}

void Arraylist::putAt(int i, int item) {//diziye eleman koyar
    if (items == NULL) {
        throw "hata";
    }
...
void Arraylist::insert(int i, int item) {//dizi icine ekme yapar
...
int Arraylist::elementAt(int i) {//indisteki elemani getirir
    if (i < 0 || i >= length) {
